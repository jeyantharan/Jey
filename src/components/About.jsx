      ...
      <div className='w-full flex flex-col'>
        ...
        >
          <p className='flex gap-3 items-center justify-center rounded-full shadow-lg py-2 px-4 bg-[#030a1c] text-white cursor-pointer'>
            <FaUserAlt size={14} /> Jeyantharan.K
          </p>
          <p className='flex gap-3 items-center justify-center rounded-full shadow-lg py-2 px-4 bg-[#030a1c] text-white cursor-pointer'>
            <MdOutlineAlternateEmail size={14} /> jeyantharan@gmail.com
          </p>
          <a
          ...
          >
            <BsWhatsapp size={14} /> +94 77 9900 299
          </a>
          <p className='flex gap-3 items-center justify-center rounded-full shadow-lg py-2 px-4 bg-[#030a1c] text-white cursor-pointer'>
            <MdWifiCalling2 size={14} /> +94 77 9900 299
          </p>
        </div>
      </div>
    </div>
